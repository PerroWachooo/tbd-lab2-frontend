        ...
        <v-card class="mx-auto" max-width="400" link color="var(--primary-a20)">
          ...
          >
            <v-card-title class="bg-primary-a40 title-background">
              ...
              Ordenes dentro de 10 KM</v-card-title>
          </v-img>

          <v-card-text>
            <div>Muestra las órdenes que han sido enviadas a clientes dentro de un radio de 10 km desde un almacén específico.</div>
          </v-card-text>

          <v-card-actions>
            <v-btn color="purple" text href="/almacenes/radio">Generar</v-btn>
          </v-card-actions>
        </v-card>
        ...
        <v-card class="mx-auto" max-width="400" color="var(--primary-a20)">
          ...
          >
            <v-card-title  class="bg-primary-a40 title-background">
              ...
              Almacen más cercano a un cliente

            </v-card-title>
          </v-img>

          <v-card-text>
            <div>Obtiene el almacén más cercano a un cliente específico para optimizar la asignación de envíos.</div>
          </v-card-text>

          <v-card-actions>
            <v-btn color="purple" href="/almacenes/cercano" text>Generar</v-btn>
          </v-card-actions>
        </v-card>
        <v-card class="mx-auto ma-8" max-width="400" link color="var(--primary-a20)">
          <v-img
            class="align-end text-white"
            height="200"
            src="/assets/logoreporte1.png"
          ...
          >
            <v-card-title class="bg-primary-a40 title-background">
              <v-icon class="me-4" icon="mdi-email-outline" size="large"></v-icon>
              Ruta más corta</v-card-title>
          </v-img>

          <v-card-text>
            <div>Calcula la ruta más corta entre un almacén y un cliente específico.</div>
          </v-card-text>

          <v-card-actions>
            <v-btn color="purple" text href="/almacenes/ruta">Generar</v-btn>
          </v-card-actions>
        </v-card>
      </v-row>
